                            ...
                            >
                                <div className="pb-2.5 w-full flex justify-between">
                                    <div className="inline-flex items-center space-x-2">
                                        ...
                                        <span className={`h-5 inline-flex items-center justify-center px-2 mb-[2px] leading-none rounded-full text-xs font-semibold text-gray-500 border border-green-300 ${column.items.length < 1 && 'invisible'}`}>{column.items?.length}</span>
                                    </div>
                                        ...
                                        {(provided, snapshot) => {
                                            return (
                                                <div
                                                    ...
                                                    className={`min-h-[530px] pt-4 duration-75 transition-colors border-t-2 border-green-400 ${snapshot.isDraggingOver && 'border-green-600'}`}
                                                >
                                                                    ...
                                                                    return (
                                                                        ...
                                                                        >
                                                                            <div className="pb-2">
                                                                                ...
                                                                                <span className="py-1 px-2.5 bg-green-100 text-green-600 rounded-md text-xs font-medium mt-1 inline-block">Task-{item.index}</span>
                                                                            </div>
                                                                        </div>
                                                                    );
                                                                }}
